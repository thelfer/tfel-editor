...
namespace tfel{
  ...
  static std::string BehaviourDescription_getFunction(
    ...
    try {
      ...
      const auto sh = ModellingHypothesis::fromString(
          bd.hypothesis.toStdString());
  ...
  QString BehaviourDescription::getFunction() const {
    return QString::fromStdString(
        BehaviourDescription_getFunction(*this));
  }  // end of BehaviourDescription::getFunction()

  std::shared_ptr<mtest::Behaviour> BehaviourDescription::generate()
      const {
    using tfel::material::ModellingHypothesis;
    try{
