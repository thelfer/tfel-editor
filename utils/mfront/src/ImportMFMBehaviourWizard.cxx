...
namespace tfel::gui {
  ...
  ImportMFMBehaviourWizard::ImportMFMBehaviourWizard(TextEditBase& t,
                                                     const Options& o)
      : QWizard(&t),
    ...
    QObject::connect(this->sb, &SelectMFMBehaviourPage::doubleClicked, this,
  ...
  BehaviourDescription ImportMFMBehaviourWizard::getSelectedBehaviour() const {
