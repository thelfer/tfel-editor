...
namespace tfel::gui {
  ...
  MFrontOptionsDialog::MFrontOptionsDialog(EditorWidget &q,
                                           MFrontOptions &o,
    ...
    if (t == MATERIALPROPERTY) {
      ...
      const auto &f = mfront::ModelInterfaceFactory::getModelInterfaceFactory();
      for (const auto &i : f.getRegistredInterfaces()) {
        interfaces->addItem(QString::fromStdString(i));
      }
    }
    ...
    if (t == BEHAVIOUR) {
      ...
      gl2->addWidget(new QLabel(QObject::tr("Performance profiling")), 4, 0);
      gl2->addWidget(rprofiling, 4, 1, Qt::AlignHCenter);
      QObject::connect(
          rprofiling, &QCheckBox::stateChanged, this,
          [this](const int s) { this->opts.profiling = s == Qt::Checked; });
    }
    //
    // actions
    ...
    QObject::connect(
        rpedantic, &QCheckBox::stateChanged, this,
        [this](const int s) { this->opts.pedantic = s == Qt::Checked; });
    vl->addLayout(gl1);
    ...
    if (uses_analytic_jacobian) {
      ...
      // criterion
      auto *const njcl2 = new QLabel(QObject::tr("Comparison criterion"));
      ...
      QObject::connect(njccb1, &QCheckBox::stateChanged, this,
                       [this, cle, ple](const int s) {
                         ...
                         this->opts.compare_to_numerical_jacobian =
                             s == Qt::Checked;
                       });
