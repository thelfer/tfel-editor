...
#include "TFEL/GUI/LicosThermalBehaviourWizard.hxx"
...
namespace tfel {
  ...
  namespace gui {
    ...
    struct LicosMaterialWizard::MaterialPage : public QWizardPage {
      explicit MaterialPage(EditorWidget &q, LicosMaterialWizard &w)
        ...
        classNameLabel->setToolTip(
            QObject::tr("The user shall provide a list of materials.\n"
        ...
        auto *classNameLineEdit = new LineEdit(q);
        classNameLabel->setBuddy(classNameLineEdit);

        auto *parentNameLabel =
            new QLabel(QObject::tr("Material description:"));
        parentNameLabel->setToolTip(QObject::tr(
            "The user shall provide a list of material description.\n"
            ...
            "Exemple : UO2"));
        auto *parentNameLineEdit = new LineEdit(q);
        ...
        // baseClassLineEdit = new LineEdit;
    ...
    LicosMaterialWizard::LicosMaterialWizard(TextEditBase &t)
        : QWizard(&t),
          textEdit(t),
          mpage(new MaterialPage(t.getEditorWidget(), *this)),
          tbw(nullptr),
          mbw(nullptr) {
