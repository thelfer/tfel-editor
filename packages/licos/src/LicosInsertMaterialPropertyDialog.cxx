...
namespace tfel::gui {
  ...
  LicosInsertMaterialPropertyDialog::LicosInsertMaterialPropertyDialog(
      TextEditBase& t)
      : QDialog(&t), textEdit(t) {
    auto* mlayout = new QVBoxLayout;
    auto* s = new MaterialPropertySelector(t.getEditorWidget(), this);
    mlayout->addWidget(s);
    this->setLayout(mlayout);
    QObject::connect(
        s, &MaterialPropertySelector::materialPropertiesSelected, this,
        &LicosInsertMaterialPropertyDialog::insertMaterialProperties);
  }

  void LicosInsertMaterialPropertyDialog::insertMaterialProperties(
      const QVector<MaterialProperty>& mps) {
