...
namespace qemacs {
  ...
  QString StandardLicosBlock::blockEnd() const {
    return "EndOf" + this->n;
  }
  ...
  void StandardLicosBlock::addKeys(const QStringList& k) {
    this->keys << k;
  }
  ...
  void StandardLicosBlock::addBlock(
      const QSharedPointer<LicosBlock> b) {
    this->blocks[b->name()] = b;
  }

  void StandardLicosBlock::addBlock(const QString& n_,
                                    const QStringList& k) {
