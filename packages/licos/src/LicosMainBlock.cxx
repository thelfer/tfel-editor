...
namespace qemacs {
  ...
  MaterialDescriptionBlock::MaterialDescriptionBlock(const QString& n_)
    ...
    this->addKeys(getParameterKeys());
    this->addBlock("ThermalBehaviour", QStringList()
                                           << "MaterialProperty");
  ...
  bool ThermalLoadingBlock::isSubKey(const QString&) const {
    return true;
  }
  ...
  struct MechanicalLoadingBlock : public StandardLicosBlock {
    explicit MechanicalLoadingBlock(
        const QString& = "MechanicalLoading");
  ...
  bool MechanicalLoadingBlock::isSubKey(const QString&) const {
    return true;
  }
  ...
  bool MechanicalPostComputationBlock::isSubBlock(
      const QString&) const {
    return false;
  ...
  RamsesStudy::RamsesStudy() : StandardLicosBlock("RamsesStudy") {
    ...
    this->addBlock("StressProfile", QStringList()
                                        << getParameterKeys());
  ...
  struct LicosProcessBlock : public StandardLicosBlock {
   ...
   protected:
    ...
    static const std::map<QString, QSharedPointer<LicosBlock>>
    buildBlocks();
  };
  ...
  QSharedPointer<LicosBlock> Block::getSubBlock(
  ...
  void LoadingBlock::treatArguments(
  ...
  QSharedPointer<LicosBlock> LoadingBlock::getSubBlock(
      const QString&) const {
  ...
  void GlobalLoadingEvolutionBlock::treatParameters(
      const QStringList&) {}
  ...
  QString LoadingEvolutionBlock::name() const {
  ...
  bool LoadingEvolutionBlock::isSubKey(const QString&) const {
    return true;
  }

  bool LoadingEvolutionBlock::isSubBlock(const QString&) const {
    return false;
  }
  ...
  LicosSpecificSectionBlock::buildBlocks() {
    ...
    b["GaseousMaterialDescription"] =
        BPtr(new GaseousMaterialDescriptionBlock);
    ...
    b["ThermalBoundaryCondition"] =
        BPtr(new ThermalBoundaryConditionBlock);
    ...
    StandardLicosBlock* ml =
        new StandardLicosBlock("MechanicalLoadings");
    ml->addKey("ML");
    ...
    b["MechanicalPostComputation"] =
        BPtr(new MechanicalPostComputationBlock);
    ...
    b["MechanicalPostProcessing"] =
        BPtr(new MechanicalPostProcessingBlock);
  ...
  LicosMainBlock::LicosMainBlock() : StandardLicosBlock("main") {
    ...
    this->addKeys(QStringList() << "CastemNames"
                                << "Date"
                                << "Dependencies"
                                << "InputFile"
                                << "GlobalCurve"
