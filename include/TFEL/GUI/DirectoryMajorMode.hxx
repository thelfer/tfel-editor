...
namespace tfel::gui {
  ...
  //! \brief a major mode dedicated to exploring a directory
  struct TFEL_GUI_VISIBILITY_EXPORT DirectoryMajorMode final : MajorModeBase {
    /*!
     ...
     */
    DirectoryMajorMode(const QString&, EditorWidget&, Buffer&, TextEditBase&);
