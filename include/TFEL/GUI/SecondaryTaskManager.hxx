...
namespace tfel{
  ...
  struct TFEL_GUI_VISIBILITY_EXPORT SecondaryTaskManager {
     ...
     * \param[in] w: widget
     */
    virtual void setCurrentSecondaryTask(Buffer *const,
                                         QWidget *const);
    /*!
     ...
     * \param[in] t: task
     */
    virtual void attachSecondaryTask(Buffer *const,
                                     const SecondaryTask &);
    /*!
     ...
     * \param[in] w: widget
     */
    virtual void detachSecondaryTask(Buffer *const,
                                     QWidget *const);
    /*!
