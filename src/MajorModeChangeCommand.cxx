...
namespace tfel{
  ...
  MajorModeChangeCommand::MajorModeChangeCommand(
      EditorWidget& p, const QString& m)
  ...
  QString MajorModeChangeCommandProxy::getName() const {
    return this->name;
  }

  Command* MajorModeChangeCommandProxy::getCommand(
      EditorWidget& t) const {
    return new MajorModeChangeCommand(t, this->mode);
  }

  MajorModeChangeCommandProxy::
      ~MajorModeChangeCommandProxy() = default;
