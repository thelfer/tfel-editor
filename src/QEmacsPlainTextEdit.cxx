...
namespace qemacs {
  ...
  QEmacsPlainTextEdit::QEmacsPlainTextEdit(QEmacsWidget& g,
                                           QEmacsBuffer& b)
      : QEmacsTextEditBase(g, b), e(new QPlainTextEdit(this)) {
...
#pragma message("warning")
  ...
  void QEmacsPlainTextEdit::cut() { this->e->cut(); }

  void QEmacsPlainTextEdit::paste() { this->e->paste(); }

  void QEmacsPlainTextEdit::selectAll() { this->e->selectAll(); }

  void QEmacsPlainTextEdit::copy() { this->e->copy(); }

  void QEmacsPlainTextEdit::clear() { this->e->clear(); }

  bool QEmacsPlainTextEdit::isReadOnly() {
  ...
  QTextCursor QEmacsPlainTextEdit::cursorForPosition(
      const QPoint& p) const {
    return this->e->cursorForPosition(p);
  }

  QRect QEmacsPlainTextEdit::cursorRect(const QTextCursor& tc) const {
  ...
  QTextDocument* QEmacsPlainTextEdit::document() const {
    return this->e->document();
  }  // end of QEmacsPlainTextEdit::document

  void QEmacsPlainTextEdit::setExtraSelections(
      const QList<QTextEdit::ExtraSelection>& l) {
    return this->e->setExtraSelections(l);
  }

  QTextCursor QEmacsPlainTextEdit::textCursor() const {
  ...
  QRect QEmacsPlainTextEdit::cursorRect() const {
  ...
  bool QEmacsPlainTextEdit::isUndoRedoEnabled() const {
