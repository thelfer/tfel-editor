...
namespace qemacs {
  ...
  QString
  QEmacsHunspellDictionariesManager::getDefaultSpellCheckLanguage()
      const {
    QSettings s;
  ...
  QString QEmacsHunspellDictionariesManager::getDictionaryPath(
  ...
  QEmacsHunspellDictionariesManager::getAvailableDictionnaries() const {
    ...
    return keys;
     ...
     // QEmacsHunspellDictionariesManager::getAvailableDictionnaries
  ...
  void QEmacsHunspellDictionariesManager::
