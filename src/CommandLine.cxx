...
namespace tfel{
  ...
  CommandLine::CustomLineEdit::CustomLineEdit(EditorWidget& q,
                                                 CommandLine& p)
      : LineEdit(q,&p),
        lineEdit(p) {
  }  // end of CommandLine::CustomLineEdit::CustomLineEdit
  ...
  void CommandLine::CustomLineEdit::setCompleter(
  ...
  }  // end of CommandLine::CustomLineEdit::setCompleter

  QCompleter* CommandLine::CustomLineEdit::completer() const {
    return this->c_;
  }  // end of CommandLine::CustomLineEdit::completer
  ...
  }  // end of CommandLine::CustomLineEdit::event
  ...
  } // end of CommandLine::CustomLineEdit::keyPressEvent
  ...
  QString CommandLine::CustomLineEdit::findCompletion(bool& b) {
    ...
    return r;
  }  // end of CommandLine::CustomLineEdit::findCompletion

  QString CommandLine::CustomLineEdit::extractBaseForCompletion(
      const QString& r) {
    return r;  //    return "";
  }  // end of CommandLine::CustomLineEdit::extractBaseForCompletion
  ...
  } // end of CommandLine::CustomLineEdit::handleShortCut

  CommandLine::CommandLine(const QString& l,
                                 EditorWidget& p,
                                 const bool b)
      : QWidget(&p),
        editor(p),
  ...
  void CommandLine::showCompletions(const QString&,
                                       const QStringList& cl) {
    if (this->completions == nullptr) {
      this->completions =
          new TextEdit(this->editor, this->buffer);
      if (this->completions == nullptr) {
        return;
      }
  ...
  void CommandLine::setLineEdit(
      CommandLine::CustomLineEdit* const i) {
    if (i == nullptr) {
      return;
    }
    if (this->input != nullptr) {
      ...
      QObject::disconnect(
          this->input, &CommandLine::CustomLineEdit::returnPressed,
          this, &CommandLine::userEditingFinished);
      QObject::disconnect(this->input,
                          &CommandLine::CustomLineEdit::textChanged,
                          this, &CommandLine::inputTextChanged);
      QObject::disconnect(this->input,
                          &CommandLine::CustomLineEdit::textEdited,
    ...
    QObject::connect(this->input,
                     &CommandLine::CustomLineEdit::returnPressed,
                     this, &CommandLine::userEditingFinished);
    QObject::connect(this->input,
                     &CommandLine::CustomLineEdit::textChanged, this,
                     &CommandLine::inputTextChanged);
    QObject::connect(this->input,
                     &CommandLine::CustomLineEdit::textEdited, this,
                     &CommandLine::inputTextEdited);
  }
  ...
  void CommandLine::inputTextChanged(const QString& t) {
    emit textChanged(t);
  }

  void CommandLine::inputTextEdited(const QString& t) {
    emit textEdited(t);
  }
  ...
  struct YesOrNoUserInput::YesOrNoLineEdit
      : CommandLine::CustomLineEdit {
  ...
  YesOrNoUserInput::YesOrNoUserInput(const QString& i,
                                                 EditorWidget& p)
  ...
  struct FilePathUserInput::FilePathLineEdit
      : CommandLine::CustomLineEdit {
    FilePathLineEdit(EditorWidget& q, CommandLine& p)
        : CustomLineEdit(q, p) {
  ...
  FilePathUserInput::FilePathUserInput(const QString& i,
                                                   EditorWidget& p)
      : CommandLine(i, p) {
    this->setLineEdit(new FilePathLineEdit(p, *this));
  }  // end of FilePathUserInput::FilePathUserInput
