  ...
  namespace gui
{
  ...
  TextBrowser::TextBrowser(EditorWidget& g,
				       Buffer& b)
    : TextEditBase(g,b),
  ...
  TextBrowser::TextBrowser(const QString& f,
				       EditorWidget& g,
				       Buffer& b)
    : TextEditBase(g,b),
      e(new QTextBrowser(this))
  ...
  QAbstractScrollArea* TextBrowser::widget()
  {
    return this->e;
  }

  void TextBrowser::undo()
  {
    this->e->undo();
  } // end of TextBrowser::undo

  void TextBrowser::redo()
  {
    this->e->redo();
  } // end of TextBrowser::redo
  ...
  QTextCursor
  TextBrowser::cursorForPosition(const QPoint& p) const
  {
    return this->e->cursorForPosition(p);
  }

  QRect
  TextBrowser::cursorRect(const QTextCursor& tc) const
  {
  ...
  void TextBrowser::setReadOnly(bool b)
  {
  ...
  QTextDocument*
  TextBrowser::document() const
  {
    return this->e->document();
  } // end of TextBrowser::document

  void TextBrowser::setExtraSelections(const QList<QTextEdit::ExtraSelection>& l)
  {
    return this->e->setExtraSelections(l);
  }
  
  QTextCursor
  TextBrowser::textCursor() const
  {
    return this->e->textCursor();
  }

  QList<QTextEdit::ExtraSelection>
  TextBrowser::extraSelections() const
  {
    return this->e->extraSelections();
  } // end of TextBrowser::extraSelections

  QRect
  TextBrowser::cursorRect() const
  {
    return this->e->cursorRect();
  }

  bool
  TextBrowser::find(const QString& t,
  ...
  bool
  TextBrowser::isUndoRedoEnabled() const
  {
