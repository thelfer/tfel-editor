...
namespace tfel{
  ...
  LineEdit::LineEdit(EditorWidget& q, QWidget* const p)
      : QLineEdit(p),
        editor(q) {}  // end ofLineEdit::LineEdit

  void LineEdit::keyPressEvent(QKeyEvent* ev) {
    if (ShortCutStyle::getShortCutStyle().getStyle() ==
        ShortCutStyle::QT) {
  ...
  } // end of LineEdit::handleShortCut

  void LineEdit::setInputHistory(const QStringList& h) {
    this->inputHistory = h;
  } // end of LineEdit::setInputHistory

  QStringList LineEdit::getInputHistory() const {
    return this->inputHistory;
  }  // end of CommandLine::CustomLineEdit::getInputHistory
