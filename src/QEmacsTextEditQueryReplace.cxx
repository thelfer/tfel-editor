...
namespace qemacs {
  ...
  QEmacsTextEditQueryReplace::QEmacsTextEditQueryReplace(
      ...
      : QEmacsLineEdit(QObject::tr("query replacing %1 with %2 "
        ...
        textEdit(t),
        stage(2) {
    auto* rf = new QEmacsTextEditReplaceFilter(
        this->qemacs, this->textEdit, *this, s1_, s2_);
    QObject::connect(rf, &QEmacsTextEditReplaceFilter::destroyed, this,
                     &QEmacsTextEditQueryReplace::userEditingFinished);
  ...
  void QEmacsTextEditQueryReplace::treatUserInput() {
    ...
    if (this->stage == 0) {
      ...
      if (i.isEmpty()) {
        ...
        this->qemacs.removeUserInput(this);
        this->qemacs.setUserInput(
            new QEmacsTextEditQueryReplace(t, q, i));
        return;
      }
  ...
  QStringList QEmacsTextEditQueryReplace::getHistory() {
    QSettings settings;
