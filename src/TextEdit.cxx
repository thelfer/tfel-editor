...
namespace tfel{
  ...
  TextEdit::TextEdit(const QString& f,
                                 EditorWidget& g,
                                 Buffer& b)
      : TextEditBase(g, b), e(new QTextEdit(this)) {
    this->initialize(this->e);
  ...
  void TextEdit::undo() {
    this->e->undo();
  } // end of TextEdit::undo

  void TextEdit::redo() {
    this->e->redo();
  } // end of TextEdit::redo
  ...
  void TextEdit::setExtraSelections(
  ...
  QList<QTextEdit::ExtraSelection> TextEdit::extraSelections()
      const {
  ...
  bool TextEdit::find(const QString& t,
  ...
  void TextEdit::centerCursor(){
  }  // end of TextEdit::centerCursor

  void TextEdit::setTextInteractionFlags(
