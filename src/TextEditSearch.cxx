...
namespace tfel{
  ...
  TextEditSearchFilter::TextEditSearchFilter(
      TextEditBase& t, TextEditSearch& p)
  ...
  void TextEditSearchFilter::lineEditDestroyed() {
    this->deleteLater();
  }

  bool TextEditSearchFilter::filterKeyPressEvent(
      QKeyEvent* const e) {
    const auto k = e->key();
  ...
  TextEditSearch::TextEditSearch(
    ...
    QObject::connect(this->sf, &TextEditSearchFilter::destroyed,
                     this,
  ...
  void TextEditSearch::setSearchOptions(
