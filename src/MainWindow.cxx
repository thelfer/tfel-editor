...
namespace tfel{
  ...
  MainWindow::MainWindow(const QStringList &f,
                                     QWidget *const p)
      : QMainWindow(p) {
    ...
    this->createMainMenu();
    QObject::connect(&s, &ShortCutStyle::shortCutStyleChanged,
                     this, &MainWindow::updateOptionsMenu);
    QObject::connect(e, &EditorWidget::closed, this,
                     &MainWindow::close);
    ...
    QObject::connect(e, &EditorWidget::bufferRemoved, this,
                     &MainWindow::updateBuffersMenu);
    QObject::connect(e, &EditorWidget::currentBufferChanged,
                     this, &MainWindow::createMainMenu);
    QObject::connect(e, &EditorWidget::currentBufferMajorModeChanged,
                     this, &MainWindow::createMainMenu);
  ...
  void MainWindow::closeEvent(QCloseEvent *ev) {
    ...
    if (e != nullptr) {
      QObject::disconnect(e, &EditorWidget::closed, this,
                          &MainWindow::close);
      if (e->close()) {
        ev->accept();
      } else {
